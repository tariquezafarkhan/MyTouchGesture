...
public class DatabaseHelperToRecordResults extends SQLiteOpenHelper
{
	  public static final String TABLE_COMMENTS = "ResultData";
	  ...
	  private static final String DATABASE_NAME = "ResultsData.db";
	  ...
	  public DatabaseHelperToRecordResults(Context context) {
	  ...
	  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	    Log.w(DatabaseHelperToRecordResults.class.getName(),
